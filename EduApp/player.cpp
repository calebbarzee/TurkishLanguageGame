///
/// Player class that keeps track of player state, movement, health,
/// score and checks for collisions with boxes.
///
/// Also responsible for drawing the player, and updating animations/
/// movement.
///
